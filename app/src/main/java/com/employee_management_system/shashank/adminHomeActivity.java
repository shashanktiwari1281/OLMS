...
public class adminHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSharedPreferences("userDetails", MODE_PRIVATE).getString("userType", null).equals("Super Admin"))
            findViewById(R.id.logOut_TV_AdminTool).setVisibility(View.VISIBLE);
